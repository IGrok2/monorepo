...
export async function updateApp(
  ...
  const response = await fetch(`${PUBLIC_API}/@/container/${id}`, {
    method: "PATCH",
    headers: new Headers({
      "content-type": "application/json",
      Authorization: token,
...
export async function updateName(id, name) {
  const response = await fetch(`${PUBLIC_API}/@/container/${id}/name`, {
    method: "PATCH",
    headers: new Headers({
      "content-type": "application/json",
      Authorization: token,
...
export async function updateBranch(id, branch) {
  const response = await fetch(`${PUBLIC_API}/@/container/${id}/branch`, {
    method: "PATCH",
    headers: new Headers({
      "content-type": "application/json",
      Authorization: token,
...
export async function updatePort(id, port) {
  const response = await fetch(`${PUBLIC_API}/@/container/${id}/port`, {
    method: "PATCH",
    headers: new Headers({
      "content-type": "application/json",
      Authorization: token,
...
export async function updateSubdirectory(id, subdirectory) {
  const response = await fetch(`${PUBLIC_API}/@/container/${id}/subdirectory`, {
    method: "PATCH",
    headers: new Headers({
      "content-type": "application/json",
      Authorization: token,
