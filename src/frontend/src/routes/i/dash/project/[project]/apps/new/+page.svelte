...
<Card.Root class="my-4">
    ...
    {:else}
        <Card.Header>
            <Card.Title>Select Git Repository</Card.Title>
            <Card.Description
                >Get ready to deploy your new project.</Card.Description
            >
        </Card.Header>
            ...
            <RadioGroup.Root id="provider" bind:value={provider}>
                <div class="flex items-center space-x-2">
                    ...
                    <Label for="github"
                        >Github <Button
                            variant="secondary"
                            on:click={manageGitHubApp}
                            >Manage GitHub Account Access</Button
                        ></Label
                    >
                </div>
                <div class="flex items-center space-x-2">
        ...
        {#if provider === "github"}
            ...
            <Card.Content class="space-y-2">
                <Popover.Root bind:open let:ids>
                    ...
                    <Popover.Content class="w-3/4 p-0">
                        <Command.Root>
        ...
        -->
            <Card.Footer class="flex justify-end">
                <Button href="new/{repoId}" disabled={!repoId}>Next</Button>
            </Card.Footer>
