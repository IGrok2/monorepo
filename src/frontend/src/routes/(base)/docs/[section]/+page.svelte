<script>
    ...
    $: section = data.section.data[0].attributes;

    $: page = section.page.data.attributes;
...
<svelte:head>
    ...
    <meta name="og:url" content="https://packetware.net/docs/{section.slug}/{page.slug}" />
...
<article class="">
    <header class="">
        <p class="text-base font-medium text-fuchsia-500">{section.name}</p>
